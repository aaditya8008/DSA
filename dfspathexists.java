...
public class dfspathexists {
    ...
    public static boolean haspath(ArrayList<edge> arr[], int curr, boolean visit[],int dest) {
        ...
        for (int i = 0; i < arr[curr].size(); i++) {
            ...
            if (!visit[e.des]&& haspath(arr, e.des, visit,dest)) {
               return true;
            }
        }
return false;
    ...
    public static void main(String args[]) {
       ...
       System.out.println( haspath(arr, 0, visit,6));
